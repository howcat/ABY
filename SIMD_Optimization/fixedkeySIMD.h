...
inline void FixedKeyHashing(AES_KEY_CTX* aeskey, BYTE* outbuf, BYTE* inbuf, BYTE* tmpbuf, uint64_t id, uint32_t bytessecparam, crypto* crypt) {
    ...
    // update
    uint64_t *tmpbuf_64_ptr = (uint64_t *)tmpbuf;
    __m128i tmpbuf_128 = _mm_insert_epi64(_mm_insert_epi64(_mm_set_epi64x(0x0000000000000000, 0x0000000000000000), tmpbuf_64_ptr[0], 0), tmpbuf_64_ptr[1], 1);
    uint64_t *inbuf_64_ptr = (uint64_t *)inbuf;
    __m128i inbuf_128 = _mm_insert_epi64(_mm_insert_epi64(_mm_set_epi64x(0x0000000000000000, 0x0000000000000000), inbuf_64_ptr[0], 0), inbuf_64_ptr[1], 1);
    tmpbuf_128 = _mm_xor_si128(tmpbuf_128, inbuf_128);
    tmpbuf_64_ptr[0] = _mm_extract_epi64(tmpbuf_128, 0);
    tmpbuf_64_ptr[1] = _mm_extract_epi64(tmpbuf_128, 1);
    tmpbuf = (BYTE *)tmpbuf_64_ptr;
    ...
    // update
    uint64_t *outbuf_64_ptr = (uint64_t *)outbuf;
    __m128i outbuf_128 = _mm_insert_epi64(_mm_insert_epi64(_mm_set_epi64x(0x0000000000000000, 0x0000000000000000), outbuf_64_ptr[0], 0), outbuf_64_ptr[1], 1);
    inbuf_128 = _mm_insert_epi64(_mm_insert_epi64(_mm_set_epi64x(0x0000000000000000, 0x0000000000000000), inbuf_64_ptr[0], 0), inbuf_64_ptr[1], 1);
    outbuf_128 = _mm_xor_si128(outbuf_128, inbuf_128);
    outbuf_64_ptr[0] = _mm_extract_epi64(outbuf_128, 0);
    outbuf_64_ptr[1] = _mm_extract_epi64(outbuf_128, 1);
    outbuf = (BYTE *)outbuf_64_ptr;
#endif
}
